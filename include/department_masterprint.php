<?php
function DisplayMasterTableInfoForPrint_department($params)
{
	global $cman;
	...
	$layout = GetPageLayout("department", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("department", "masterprint"));
}
