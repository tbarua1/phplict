<?php
function DisplayMasterTableInfoForPrint_division($params)
{
	global $cman;
	...
	$layout = GetPageLayout("division", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("division", "masterprint"));
}
