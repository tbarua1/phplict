<?php
function DisplayMasterTableInfoForPrint_university($params)
{
	global $cman;
	...
	$layout = GetPageLayout("university", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("university", "masterprint"));
}
