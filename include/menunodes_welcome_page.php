...
function getMenuNodes_welcome_page($menuNodesObject)
{
	...
	$menuNode["href"] = "mypage.htm";
	$menuNode["type"] = "Leaf";
	$menuNode["table"] = "batch_completion_status";
	$menuNode["style"] = "";
	$menuNode["params"] = "";
	$menuNode["parent"] = "1";
	$menuNode["nameType"] = "Text";
	...
	$menuNode["title"] = "Batch Completion Status";
