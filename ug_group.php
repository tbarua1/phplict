...
$nonAdminTablesArr[] = "batch";
$nonAdminTablesArr[] = "courses";
$nonAdminTablesArr[] = "department";
$nonAdminTablesArr[] = "district";
$nonAdminTablesArr[] = "division";
$nonAdminTablesArr[] = "emp_status";
$nonAdminTablesArr[] = "university";
$nonAdminTablesArr[] = "employees";
$nonAdminTablesArr[] = "full_batch_details";
$nonAdminTablesArr[] = "batchschedule";
$nonAdminTablesArr[] = "schedule_map";
$nonAdminTablesArr[] = "batch_completion_status";
$nonAdminTablesArr[] = "employees1";
$nonAdminTablesArr[] = "consultant_view";
$nonAdminTablesArr[] = "consultant";
...
$wGroupTableName = $ug_connection->addTableWrappers( "lict_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "lict_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "lict_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "lict_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "lict_ugmembers" );
