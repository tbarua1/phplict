...
require_once("include/newbatchschedule_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "newbatchschedule_print";
...
$page_layouts["newbatchschedule_print"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "batch_masterprint";
...
$page_layouts["batch_masterprint"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "newbatchschedule" );
