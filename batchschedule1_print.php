...
require_once("include/batchschedule1_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "batchschedule1_print";
...
$page_layouts["batchschedule1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "batchschedule1" );
