...
require_once("include/batch_completion_status_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "batch_completion_status_print";
...
$page_layouts["batch_completion_status_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "batch_completion_status" );
