...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("employees", PAGE_LIST);
	}
...
function GetTableURL($table = "")
{
	...
	if("employees" == $table) 
		return "employees";
	if("full_batch_details" == $table) 
		return "full_batch_details";
	if("trainer" == $table) 
		return "trainer";
	if("university" == $table) 
		return "university";
	if("university_view" == $table) 
...
{	
	...
	if("batch" == $shortTName) 
		return "batch";
	if("batchschedule" == $shortTName) 
		return "batchschedule";
	if("consultant" == $shortTName) 
		return "consultant";
	if("courses" == $shortTName) 
		return "courses";
	if("department" == $shortTName) 
		return "department";
	if("district" == $shortTName) 
		return "district";
	if("division" == $shortTName) 
		return "division";
	if("emp_status" == $shortTName) 
		return "emp_status";
	if("employees" == $shortTName) 
		return "employees";
	if("full_batch_details" == $shortTName) 
		return "full_batch_details";
	if("trainer" == $shortTName) 
		return "trainer";
	if("university" == $shortTName) 
		return "university";
	if("university_view" == $shortTName) 
		return "university_view";
}
