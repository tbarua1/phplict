...
require_once("include/schedule_map_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "schedule_map_print";
...
$page_layouts["schedule_map_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "schedule_map" );
