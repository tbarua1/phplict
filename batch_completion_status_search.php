...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "batch_completion_status_search";
...
$page_layouts["batch_completion_status_search"] = $layout;
...
$params['shortTableName'] = 'batch_completion_status';
